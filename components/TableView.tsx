            ...
            <div className="text-center flex-1">
              ...
              <div className="flex flex-col items-center mt-0.5">
                <div className="flex items-center justify-center gap-2">
                  ...
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 4v1m0 11v1m4-8h1m-1 4h1m-9-4h1m-1 4h1M4 4h4v4H4V4zm0 12h4v4H4v-4zm12 0h4v4h-4v-4zm0-12h4v4h-4V4z" /></svg>
                    VIEW BILL
                  </button>
                  <button 
